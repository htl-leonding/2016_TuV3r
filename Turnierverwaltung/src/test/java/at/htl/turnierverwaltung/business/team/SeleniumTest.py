...
time.sleep(1)
firstNextButtonId = "menu_steps:j_idt31"
firstNextButtonElement = WebDriverWait(driver, 10).until(lambda driver: driver.find_element_by_id(firstNextButtonId))
...
time.sleep(1)
secondNextButtonId = "menu_steps:j_idt31"
secondNextButtonElement = WebDriverWait(driver, 10).until(lambda driver: driver.find_element_by_id(secondNextButtonId))
